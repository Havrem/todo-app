...
import { Category, UpdateCategoryFormData, UpdateCategoryInput, updateCategorySchema } from "@/schemas/category";
...
export function EditCategoryForm({ category }: { category: Category }) {
    const { t } = useTranslation(['editCategory', 'common']);
    ...
    return (
      <>
        ...
        <View style={styles.bottom}>
          <Button text={t('common:save')} onPress={handleSubmit(onSubmit)}/>
        </View>
      </>
    );
}
